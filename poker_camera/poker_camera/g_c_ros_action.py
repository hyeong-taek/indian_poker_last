...
######################
        ...
        self.gaze_pub = self.create_publisher(Float32, '/dsr01/agree_to_pub', 10)
    ...
    def exec_cb_behave(self, goal_handle):
        ...
        agree_time = Float32()
        agree_time.data = duration_s
        self.gaze_pub.publish(agree_time)
    ...
    def image_callback(self, msg: RosImage):
        ...
        if self._mode == 'card':
            ...
            if res_pose and res_pose.pose_landmarks:
                ...
                frame = draw_kor(frame, picked, (10, 35), 32, (255,200,0))
